...
function pageContext({ assetVersion, cssVersion, jsVersion, fontAwesomeVersions, eventAliases = {}, eventAliasVersion = '' }) {
  return {
    ...
    modulePreloads: ['menu-drawer', 'subscribe', 'theme', 'analytics', 'plan-storage', 'plan-export', 'plans-page', 'community-plans', 'community-prompt', 'popular-page', 'weather', 'events-data', 'search-text', 'casetas-navigation', 'post-fiestas-banner']
